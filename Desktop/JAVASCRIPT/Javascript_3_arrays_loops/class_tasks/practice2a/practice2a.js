...
function weatherAdvice(temperature, isRaining, umbrella) {
    ...
    console.log(advice);(umbrella)
}

let balance= 30000
function atm(balance , action , amount, withdraw){
   if (action === withdraw){
   if (action > 5000)
...
console.log (atm(balance , "withdraw",1000 ))
